...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:../../step2/local/step2_local_ApplyZShiftFalse.root'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_local_ApplyZShiftFalse.root'),
