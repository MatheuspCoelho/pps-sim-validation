...
db_tag = 'PPSOpticalFunctions_2021_mc_v1'  # database tag
#########################

import FWCore.ParameterSet.Config as cms

process = cms.Process("retrievePPSOpticalFunctionsConfig")
...
process.retrieve_config = cms.EDAnalyzer("RetrievePPSOpticalFunctions",
                                         toGet = cms.VPSet(cms.PSet(
