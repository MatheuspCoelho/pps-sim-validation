...
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_pps/sim-validation/directsim/step3/step3_1.root'))
...
process.out = cms.OutputModule('PoolOutputModule',
    fileName = cms.untracked.string('step4_vtx0_ApertureCutsOn_1.root'),
