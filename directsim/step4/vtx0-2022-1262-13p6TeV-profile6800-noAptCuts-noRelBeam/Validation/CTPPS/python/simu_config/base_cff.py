...
ctppsBeamParametersFromLHCInfoESSource = cms.ESProducer("CTPPSBeamParametersFromLHCInfoESSource",
  ...
  #  beam divergence  (rad)
  beamDivX45 = cms.double(0E-6),
  beamDivX56 = cms.double(0E-6),
  beamDivY45 = cms.double(0E-6),
  beamDivY56 = cms.double(0E-6),
  ...
  #  vertex sigma  (cm)
  vtxStddevX = cms.double(0E-4),
  vtxStddevY = cms.double(0E-4),
  vtxStddevZ = cms.double(0)
)
...
ctppsDirectProtonSimulation.produceHitsRelativeToBeam = False
